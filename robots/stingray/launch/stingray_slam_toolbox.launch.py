...
#
# stingray LD14 LIDAR starts with a delay, so it is sometimes necessary to launch slam_toolbox manually in a separate shell
#
...
def generate_launch_description():
    ...
    slam_toolbox_params_file = os.path.join(package_path,'robots','stingray','config','mapper_params.yaml')
