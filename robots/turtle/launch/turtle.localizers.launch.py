"""
Turtle-specific localizers launcher.
Includes the generic launch/localizers.launch.py with turtle defaults.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('robot_model', default_value='turtle'),
