...
#
# Generate launch description for Seggy robot — multi-robot safe version
#
...
#
#   ros2 launch articubot_one seggy.launch.py namespace:=robot1
#   ros2 launch articubot_one seggy.launch.py namespace:=robot2
#
