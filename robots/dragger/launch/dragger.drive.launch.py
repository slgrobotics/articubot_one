...
#
# Generate launch description for Dragger robot drive system
#
# This launch file includes the generic "drive.launch.py" with appropriate
# parameters for the Dragger robot.
#
...
def generate_launch_description():
    ...
    # Accept launch arguments from parent (dragger.launch.py)
    namespace = LaunchConfiguration('namespace', default='')
    use_sim_time = LaunchConfiguration('use_sim_time', default='false')
    robot_model = LaunchConfiguration('robot_model', default='')

    # Dragger uses common differential drive system, and we have a "generic" drive launch for that.
