...
#
# A convenience/compatibility wrapper to launch fido.launch.py with sim time enabled
#
# To launch Fido sim:
#
# cd ~/robot_ws; colcon build; ros2 launch articubot_one fido_sim.launch.py
#
...
def generate_launch_description():
    ...
    fido_launch = IncludeLaunchDescription(
