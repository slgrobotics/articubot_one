...
#
# Generate launch description for Fido robot sensors
#
...
def generate_launch_description():
    ...
    # Keep interface compatible with being included from fido.launch.py
    ...
    ldlidar_node = Node(
        ...
        parameters=[
          ...
          {'laser_scan_dir': True},
          # Fido has vertical bar behind the LiDAR, so we crop angles around 180 degrees:
